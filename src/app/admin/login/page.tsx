...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-md mx-auto py-20 space-y-4 text-slate-900">
      <h1 className="text-2xl font-bold">Admin Login</h1>

      <input
        type="email"
        placeholder="Email"
        className="w-full border border-brand-300 p-2 rounded bg-white text-brand-900 placeholder:text-brand-muted focus:outline-none focus:ring-2 focus:ring-brand-200"
        value={email}
